...
export default function Sidebar({ handleFormOpen }) {
  ...
  return (
    <CustomSidebar>
          ...
          {Menu.map((item, key) => {
            return (
              <StyledButton
                key={key}
                className={
                  item.Title === currentPage ? "primary" : "transparent"
                }
                alignLeft
              >
      ...
      <div className="Bottom">
        <StyledButton alignLeft className={"primary"}>
        ...
        <StyledButton alignLeft className={"primary"}>
          <button type="button" onClick={toggleTheme}>
            {isDark === true ? <Brightness3 /> : <WbSunny />}
            Dark/Light
          </button>
        </StyledButton>
